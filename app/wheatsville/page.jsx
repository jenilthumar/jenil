...
const WheatsvillePage = () => {
  ...
  return (
    <div>
      {/* ----- Header ----- */}
      <div
        className={`flex justify-between items-center lg:max-w-[45rem] w-full mx-auto mt-[2.36rem] ${mobilePadding} ${desktopPadding}`}
      >
        <motion.h2
        ...
        >
          ...
          <a
            ...
            className="ms-[1.5rem] bg-[#1a1a1a] text-white py-[0.6rem] px-[1.25rem] rounded-[0.5rem] hover:opacity-80 transition-all text-[1.1rem] font-[550]"
          >
            send mail
          </a>
        </motion.div>
      ...
      {/* ----- Title Block ----- */}
      <div
        className={`mt-12 lg:mt-[3.88rem] lg:max-w-[45rem] w-full mx-auto ${mobilePadding} ${desktopContentPadding}`}
      >
        <motion.p
      ...
      {/* ----- Context Section ----- */}
      <div
        className={`mt-12 lg:mt-[4rem] max-w-[45rem] mx-auto w-full ${mobilePadding} ${desktopContentPadding}`}
      >
        ...
        <div className="text-[#1a1a1a] text-base lg:text-[1.25rem] font-[500] mt-4 lg:mt-[1.5rem] leading-normal">
          Wheatsville Co-op is a community-owned food cooperative in Austin,
          Texas.
        </div>
        {/* Adjust font size, margin, and leading */}
        <div className="text-[#1a1a1a] text-base lg:text-[1.25rem] font-[500] mt-4 lg:mt-[1.5rem] leading-normal">
          Their previous website was outdated. They wanted a fresh look and
          experience while keeping their brand touch there, It was collaboration
          with my friend Taylor. He guided me with design and brand direction
          and I designed new wireframes.
        </div>
      </div>
      ...
      <div
        className={`mt-12 lg:mt-[4rem] max-w-[65rem] mx-auto w-full ${mobilePadding} ${desktopImagePadding}`}
      >
        <img
          src="/wv/wv-2.webp"
          className="max-h-[30rem] lg:max-h-[56rem] w-full object-cover rounded-lg"
          alt="Wheatsville Screenshot 2"
        />
      </div>
      <div
        className={`mt-8 lg:mt-[4rem] max-w-[65rem] mx-auto w-full ${mobilePadding} ${desktopImagePadding}`}
      >
        <img
          src="/wv/wv-3.webp"
          className="max-h-[30rem] lg:max-h-[56rem] w-full object-cover rounded-lg"
          alt="Wheatsville Screenshot 3"
        />
      </div>
      <div
        className={`mt-8 lg:mt-[4rem] max-w-[65rem] mx-auto w-full ${mobilePadding} ${desktopImagePadding}`}
      ...
      >
        {/* Adjust font size, margin, and leading */}
        <div className="text-[#1a1a1a] text-base lg:text-[1.25rem] font-[500] mt-4 lg:mt-[1.5rem] leading-normal">
          I've come to realize that while working on concept projects, it's
          tempting to focus on creating visually stunning designs that catch the
          eye. However, in real-world projects for actual businesses,
          prioritizing user experience and ensuring a smooth flow through the
          user interface becomes essential. It's important to understand that a
          website should serve its purpose and meet its goals, rather than just
          being aesthetically pleasing. This valuable insight has been my key
      ...
      {/* ----- Next Project ----- */}
      <div
        className={`lg:w-[45rem] mx-auto ${mobilePadding} ${desktopContentPadding}`}
      >
        <div
          className="mt-16 lg:mt-[6rem] cursor-pointer"
          onClick={() => router.push("/shilp")}
        >
          <div
          ...
          <img
            src="/wv/wv-8.webp"
            className="mt-6 lg:mt-[2rem] w-full h-auto rounded-lg"
            alt="Shilp Project"
          />{" "}
          {/* Added rounded-lg */}
          {/* Title */}
