    ...
    return (
        <div>
                ...
                <div className="mt-[2rem]">
                    <div className="flex justify-between lg:pe-[4rem] text-[1.125rem]">
                        <div>
                            ...
                            <div className="text-[#1a1a1a]">in-house product(founder)</div>
                        </div>
                        <div>
                            <div className="text-[#464646]">model</div>
                            <div className="text-[#1a1a1a]">enterprise, b2b</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-[45rem] mx-auto w-full px-2 lg:px-0">
                <div className="mt-[4rem] text-[2rem] text-[#1a1a1a] font-[500] tracking-tight">problem discovery</div>
                <p className="mt-[1.5rem] text-[#1a1a1a] text-[1.25rem] font-[400]" style={{ lineHeight: "140%" }}>
                    Real estate and construction ofte   n rely on Whatsapp and calls for communication which is time-consuming and not a very reliable and effective form of communication considering many types of individuals and departments are involved to achieve a common goal.
                </p>
                <div className="mt-[1.5rem] ps-[1.5rem]">
                    <ul className="list-disc text-[1.25rem]">
                        <li className="mt-[1.5rem] text-[#1a1a1a] font-[400]" style={{ lineHeight: "140%" }}>
                ...
                <div className="mt-[1.5rem] flex flex-col gap-y-[1rem]">
                    <p className="text-[#1a1a1a] text-[1.25rem] font-[400] bg-[#E6E6E6] px-[0.81rem] py-[0.41rem] rounded-[2.5rem] inline w-fit">1. Whatsapp has limitations</p>
                    <p className="text-[#1a1a1a] text-[1.25rem] font-[400] bg-[#E6E6E6] px-[0.81rem] py-[0.41rem] rounded-[2.5rem] inline w-fit">2. Inefficient site-to-office coordination</p>
                    <p className="text-[#1a1a1a] text-[1.25rem] font-[400] bg-[#E6E6E6] px-[0.81rem] py-[0.41rem] rounded-[2.5rem] inline w-fit">3. Data accessibility </p>
                    <p className="text-[#1a1a1a] text-[1.25rem] font-[400] bg-[#E6E6E6] px-[0.81rem] py-[0.41rem] rounded-[2.5rem] inline w-fit">4. Scattered customer records</p>
                    <p className="text-[#1a1a1a] text-[1.25rem] font-[400] bg-[#E6E6E6] px-[0.81rem] py-[0.41rem] rounded-[2.5rem] inline w-fit">5. Lack of sales pipeline visibility</p>
                </div>
                <div className="mt-[4rem]">
                    <div className="text-[#1a1a1a] font-[500] text-[2rem]">Goal</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">A digitally centralized and synced workspace for</div>
                ...
                <div className="mt-[4rem]">
                    <div className="text-[#1a1a1a] font-[500] text-[2rem]">Process</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">I started the process by asking lots of questions to one of the stakeholders who is also my close uncle and has been in construction and real estate for over 20y.</div>
                </div>
                <div className="mt-[4rem]">
                    <img src="sn/sitenote-s-2.webp" className="max-h-[56rem] w-full object-cover" alt="" />
                </div>
                <p className="text-center text-[1.125rem] text-[#808080] mt-[1rem]">This was written by me on the very first day of kick-off :)</p>
                <div className="mt-[4rem]">
                    <div className="text-[#1a1a1a] font-[500] text-[2rem]">Research</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">The main method of research was in-person interviews with stakeholders.</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">I had a pretty good idea about this business due to it being a popular business in our family which helped me a lot to come up with a solution initially. I continued taking interviews and talking with stakeholders throughout the project.</div>
                </div>
                <div className="mt-[4rem] p-[1.5rem] bg-[#ED6A47] rounded-[0.5rem] text-white">
                    <div className="font-[500] text-[1.5rem]">Key findings</div>
                    <div className="mt-[2rem]">
                        <div className="flex gap-x-[1rem] text-[1.25rem] font-[500]">
                        ...
                        <div className="flex gap-x-[1rem] text-[1.25rem] font-[500] mt-[2rem]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                ...
                <div className="mt-[4rem]">
                    <div className="text-[#1a1a1a] font-[500] text-[2rem]">Product Scope & Flow</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">Sitenote includes five major features that address a wide range of user demands which are displayed as channels.</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">As previously said, not everyone uses every feature. So I decided to create three user roles with different views and set up access accordingly.</div>
                </div>
                <div className="mt-[4rem]">
                    <img src="sn/sitenote-s3.webp" className="max-h-[56rem] w-full object-cover" alt="" />
                </div>
                <div className="mt-[4rem] p-[1.5rem] bg-[#ED6A47] rounded-[0.5rem] text-white">
                    <div className="bg-white text-black flex w-fit text-[1.25rem] font-[500] gap-x-[0.62rem] px-[1rem] py-[0.5rem] rounded-full">
                    ...
                    <p className="mt-[2rem] font-[400] text-[1.25rem]">
            ...
            <div className="lg:max-w-[45rem] mx-auto px-2 lg:px-0">
                <div className="mt-[4rem]">
                    <div className="text-[#1a1a1a] font-[500] text-[2rem]">never miss anything and be in sync with teammates</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">You can not look at app every other 5 min to check if there is activity like your teammate marking some property as sold or someone put a important update regarding some property , you can miss on lots of details, but you have to focus on actual work.</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">Solution! Activity tab, this helps users stay on line with everyone regarding things they are associated with like projects, listings etc through instant updates that took place.</div>
                </div>
                <div className="mt-[6rem]">
                    <img src="sn/sc-7.webp" className="h-[33rem] object-cover rounded-lg mx-auto" alt="" />
                </div>
                <div className="mt-[4rem]">
                    <div className="text-[#1a1a1a] font-[500] text-[2rem]">tasks can be forgetful and complicated, let&apos;s make them simple and not easy to forget</div>
                    <div className="mt-[1.5rem] text-[1.25rem]">Solution! Tasks channel is a versatile feature designed to help with creating, assigning and managing day to day tasks. It is mainly used by Admins to create and assign tasks to office and site users. It simplifies task management by providing sub features like; Progress tracking, Collaboration.</div>
                </div>
            </div>
            <div className="mt-[6rem] grid lg:grid-cols-3 lg:gap-x-[4rem] lg:gap-y-[6rem] lg:max-w-[60rem] mx-auto">
            ...
            <div className="lg:w-[45rem] mx-auto px-2 lg:px-0">
                <div className="text-[#1a1a1a] font-[500] text-[2rem] mt-[6rem]" style={{ lineHeight: "normal" }}>And some additional things like material, analytics, rent that helps a lot</div>
            </div>
            <div className="mt-[4rem]">
