...
const SitenotePage = () => {
  ...
  // Helper array for images to avoid repetition (Optional but cleaner)
  const grid1Images = [
    { src: "/sn/sc-1.webp", alt: "Screenshot 1" },
    { src: "/sn/sc-2.webp", alt: "Screenshot 2" },
    { src: "/sn/sc-3.webp", alt: "Screenshot 3" },
    { src: "/sn/sc-4.webp", alt: "Screenshot 4" },
    { src: "/sn/sc-5.webp", alt: "Screenshot 5" },
    { src: "/sn/sc-6.webp", alt: "Screenshot 6" },
  ];

  const grid2Images = [
     { src: "/sn/sc-8.webp", alt: "Screenshot 8" },
     { src: "/sn/sc-9.webp", alt: "Screenshot 9" },
     { src: "/sn/sc-10.webp", alt: "Screenshot 10" },
     { src: "/sn/sc-11.webp", alt: "Screenshot 11" },
     { src: "/sn/sc-12.webp", alt: "Screenshot 12" },
     { src: "/sn/sc-13.webp", alt: "Screenshot 13" },
     { src: "/sn/sc-14.webp", alt: "Screenshot 14" },
     { src: "/sn/sc-15.webp", alt: "Screenshot 15" },
     { src: "/sn/sc-16.webp", alt: "Screenshot 16" },
  ];
  ...
  return (
    <div>
      ...
      <div className="mt-12 lg:mt-[4rem]">
        <img src="/sn/sitenote-cover-image.webp" className="max-h-[40rem] lg:max-h-[56rem] w-full object-cover" alt="Sitenote Cover" />
      </div>
      ...
      {/* ----- Image Section 1 ----- */}
      <div className="mt-12 lg:mt-[4rem] max-w-[45rem] mx-auto w-full">
        <img src="/sn/sitenote-s-1.webp" className={`max-h-[24rem] lg:max-h-[33rem] h-full w-full object-cover ${mobilePadding} lg:px-0`} alt="Sitenote Screenshot 1" />
      </div>
      ...
      <div className={`max-w-[45rem] mx-auto w-full ${mobilePadding} ${desktopPadding}`}>
        ...
        {/* Image Section 2 */}
        <div className="mt-12 lg:mt-[4rem]">
          <img src="/sn/sitenote-s-2.webp" className="max-h-[40rem] lg:max-h-[56rem] w-full object-cover" alt="Sitenote Screenshot 2" />
        </div>
        <p className="text-center text-sm lg:text-[1.125rem] text-[#808080] font-[400] mt-2 lg:mt-[1rem]">This was written by me on the very first day of kick-off :)</p>
        ...
        {/* Product Scope & Flow */}
        <div className="mt-12 lg:mt-[4rem]">
           <div className="text-[#1a1a1a] font-[600] text-[1.75rem] lg:text-[2rem] tracking-tight">product scope & flow</div>
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">Sitenote includes five major features that address a wide range of user demands which are displayed as channels.</div>
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">As previously said, not everyone uses every feature. So I decided to create three user roles with different views and set up access accordingly.</div>
         </div>

         {/* Image Section 3 */}
         <div className="mt-12 lg:mt-[4rem]">
           <img src="/sn/sitenote-s3.webp" className="max-h-[40rem] lg:max-h-[56rem] w-full object-cover" alt="Sitenote Screenshot 3" />
         </div>

         {/* Key Design Decision Box */}
         <div className="mt-12 lg:mt-[4rem] p-4 lg:p-[1.5rem] bg-[#ED6A47] rounded-[0.5rem] text-white">
           <div className="bg-white text-black flex w-fit text-base lg:text-[1.25rem] font-[600] tracking-tight gap-x-2 lg:gap-x-[0.62rem] px-3 py-1.5 lg:px-[1rem] lg:py-[0.5rem] rounded-full items-center">
             <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 25 25" fill="none" className="lg:mt-[2px]">
         ...
         {/* Redefining Booking Section */}
         <div className="mt-12 lg:mt-[4rem]">
           <div className="text-[#1a1a1a] font-[600] tracking-tight text-[1.75rem] lg:text-[2rem]">redefining booking and sales</div>
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">During research, I noticed that booking and sales are aspects that can be heavily optimized by centralized communication. Booking tab will be used by Top level and office staff.</div>
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">In booking channel, Project details, property listings, and customer information are centralized and accessible anytime, anywhere, by authorized users. Sitenote enhances visibility into the entire sales pipeline and process by consolidating all property and booking data. It maintains comprehensive customer account details and histories. The team and management can track progress through dedicated message channels within each property listing, facilitating organized and purposeful communication, eliminating misunderstandings and clutter.</div>
         </div>
      </div>
      ...
      >
        {grid1Images.map((img) => (
          <img
            ...
            src={img.src}
            className={`
                w-4/5 flex-shrink-0 snap-center md:w-full md:snap-auto
      ...
      {/* ----- Sync Section ----- */}
      <div className={`lg:max-w-[45rem] mx-auto ${mobilePadding} ${desktopPadding}`}>
        <div className="mt-12 lg:mt-[4rem]">
           <div className="text-[#1a1a1a] font-[600] tracking-tight text-[1.75rem] lg:text-[2rem]">never miss anything and be in sync with teammates</div>
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">You can not look at app every other 5 min to check if there is activity like your teammate marking some property as sold or someone put a important update regarding some property , you can miss on lots of details, but you have to focus on actual work.</div>
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">Solution! Activity tab, this helps users stay on line with everyone regarding things they are associated with like projects, listings etc through instant updates that took place.</div>
         </div>
        {/* Single Screenshot */}
        <div className="mt-12 lg:mt-[6rem]">
           <img
             src="/sn/sc-7.webp"
             className="w-full max-w-xs lg:max-w-xs h-auto object-cover rounded-lg mx-auto" // Keep max-width constraint here
             alt="Screenshot 7 - Activity Tab"
           />
         </div>

        {/* Tasks Section */}
        <div className="mt-12 lg:mt-[4rem]">
           <div className="text-[#1a1a1a] font-[600] tracking-tight text-[1.75rem] lg:text-[2rem]">tasks can be forgetful and complicated, let's make them simple and not easy to forget</div>
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">Solution! Tasks channel is a versatile feature designed to help with creating, assigning and managing day to day tasks. It is mainly used by Admins to create and assign tasks to office and site users. It simplifies task management by providing sub features like; Progress tracking, Collaboration.</div>
         </div>
      </div>
      ...
      {/* ----- Additional Things Section ----- */}
      <div className={`lg:w-[45rem] mx-auto ${mobilePadding} ${desktopPadding}`}>
         <div className="text-[#1a1a1a] font-[600] tracking-tight text-[1.75rem] lg:text-[2rem] mt-12 lg:mt-[6rem]" style={{ lineHeight: "normal" }}>And some additional things like material, analytics, rent that helps a lot</div>
      </div>
      {/* Image Section 4 */}
      <div className="mt-8 lg:mt-[4rem]">
         <img src="/sn/sc-17.webp" className="max-h-[40rem] lg:max-h-[56rem] w-full object-cover" alt="Screenshot 17" />
      </div>

      {/* ----- Conclusion Section ----- */}
      <div className={`lg:w-[45rem] mx-auto ${mobilePadding} ${desktopPadding}`}>
        <div className="mt-12 lg:mt-[6rem]">
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">The app is currently used daily by the Sangani group in construction and the Opera group in real estate, and it has received positive feedback.</div>
           <div className="mt-4 lg:mt-[1.5rem] text-base lg:text-[1.25rem] font-[500] leading-snug">The Sitenote for web launched in April 2024. As the founder who discovered and designed this product, I experienced an incredible learning journey. I particularly enjoyed the daily design demos and weekly stakeholder meetings, which significantly enhanced the app's quality by offering valuable insights into client needs and engineering challenges. Looking back, I would prioritize addressing the primary issue of booking functionality, rather than getting sidetracked by secondary features.</div>
        </div>

        {/* ----- Next Project ----- */}
         <div className="mt-16 lg:mt-[6rem] cursor-pointer" onClick={() => router.push("/veriprod")}>
           <div className="text-[#1a1a1a] font-[600] text-[1.75rem] lg:text-[2rem]" style={{ lineHeight: "normal" }}>next project</div>
           <div className="relative w-full aspect-[3/2] lg:aspect-auto lg:h-[30rem] rounded-[0.5rem] overflow-hidden mt-6 lg:mt-[2rem]">
             <img src="/sn/sc-18.webp" className="absolute inset-0 w-full h-full object-cover" alt="Veriprod Project" />
           </div>
           <div className="mt-6 lg:mt-[2rem] text-[1.5rem] lg:text-[2rem] font-[600] tracking-tight" style={{ lineHeight: "normal" }}>
           ...
           <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.4 }} viewport={{ once: true }}
            >
              <motion.div className={`p-2 lg:p-[0.75rem] bg-[#f5f5f5] rounded-[3.125rem] text-[#505050] text-sm lg:text-base font-[500] inline-block`} whileHover={{ backgroundColor: "#d6d6d6" }} transition={{ duration: 0.2 }}>
                app design
              </motion.div>
              <motion.div className={`ms-2 lg:ms-[1rem] p-2 lg:p-[0.75rem] bg-[#f5f5f5] rounded-[3.125rem] text-[#505050] text-sm lg:text-base font-[500] inline-block`} whileHover={{ backgroundColor: "#d6d6d6" }} transition={{ duration: 0.2 }}>
                showcase
              </motion.div>
              <motion.div className={`ms-2 lg:ms-[1rem] p-2 lg:p-[0.75rem] bg-[#f5f5f5] rounded-[3.125rem] text-[#505050] text-sm lg:text-base font-[500] inline-block`} whileHover={{ backgroundColor: "#d6d6d6" }} transition={{ duration: 0.2 }}>
                hobby project
